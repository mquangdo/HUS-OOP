...
public class StringAndCharacterExercise {
    ...
    public static void testCountVowelsDigits(){
        ...
        System.out.println("Number of vowels: " + countVowels + " " + "(" + Math.round(countVowels/str.length()) * 100.0 + "%)" );
        System.out.println("Number of digits: " + countDigits + " " + "(" + Math.round(countDigits/str.length()) * 100.0 + "%)" );
    }
    ...
    public static String phoneKeyPad2(String inStr){
        ...
        for(int i = 0; i < inStr.length()-1; i++){
            switch (inStr.charAt(i)){
                case 'a' : case 'b' : case 'c': res += 2;
                    break;
                case 'd' : case 'e' : case 'f': res += 3;
                    break;
                case 'g' : case 'h' : case 'i': res += 4;
                    break;
                case 'j' : case 'k' : case 'l': res += 5;
                    break;
                case 'm' : case 'n' : case 'o': res += 6;
                    break;
                case 'p' : case 'q' : case 'r': case 's':  res += 7;
                    break;
                case 't' : case 'u' : case 'v': res += 8;
                    break;
                case 'w' : case 'x' : case 'y': case 'z': res += 9;
                    break;
            }
        }
        return res;
    ...
    public static int radixNToDecimal(String radixNStr,int num){
        return Integer.parseInt(radixNStr,num);
    }

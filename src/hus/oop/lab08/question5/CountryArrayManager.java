...
public class CountryArrayManager {
    ...
    public AfricaCountry[] filterAfricaCountry() {
        List<AfricaCountry> africaCountriesList = new ArrayList<>();
    ...
    public AsiaCountry[] filterAsiaCountry() {
        List<AsiaCountry> asiaCountriesList = new ArrayList<>();
        for (Country country : this.countries) {
    ...
    public EuropeCountry[] filterEuropeCountry() {
        List<EuropeCountry> europeCountriesList = new ArrayList<>();
        for (Country country : this.countries) {
    ...
    public NorthAmericaCountry[] filterNorthAmericaCountry() {
        List<NorthAmericaCountry> northAmericaCountriesList = new ArrayList<>();
        for (Country country : this.countries) {
    ...
    public OceaniaCountry[] filterOceaniaCountry() {
        List<OceaniaCountry> oceanCountriesList = new ArrayList<>();
        for (Country country : this.countries) {
    ...
    public SouthAmericaCountry[] filterSouthAmericaCountry() {
        List<SouthAmericaCountry> southAmericaCountriesList = new ArrayList<>();
        for (Country country : this.countries) {

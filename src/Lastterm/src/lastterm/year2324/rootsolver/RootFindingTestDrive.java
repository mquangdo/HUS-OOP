...
public class RootFindingTestDrive {
    ...
    public static void testRootSolver() {
        ...
        System.out.println("\nBisection method:");
        System.out.println("Tolerance: 0.001");
        System.out.println("Max iterations: 1000");
        BisectionSolver bisectionSolver = new BisectionSolver(0.001, 1000);
        ...
        System.out.println("Tolerance: 0.001");
        System.out.println("Max iterations: 1000");
        SecantSolver secantSolver = new SecantSolver(0.001,1000);
        ...
        System.out.println("Tolerance: 0.001");
        System.out.println("Max iterations: 1000");
        NewtonRaphsonSolver newtonRaphsonSolver = new NewtonRaphsonSolver(0.001, 1000);
